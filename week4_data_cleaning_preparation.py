...
# 10. Data Consistency Flags & Geographic Filters
...
# 11. Feature Engineering (Sold Dataset)
...
# 12. Statistical Outlier Removal (IQR)
Q1 = sold_with_rates_df['ClosePrice'].quantile(0.25)
Q3 = sold_with_rates_df['ClosePrice'].quantile(0.75)
IQR = Q3 - Q1
sold_with_rates_df = sold_with_rates_df[(sold_with_rates_df['ClosePrice'] >= (Q1 - 1.5 * IQR)) & (sold_with_rates_df['ClosePrice'] <= (Q3 + 1.5 * IQR))]
